...
import { ArrowDown, ArrowLeft, ArrowRight, ArrowUp, ArrowUpRight, Check, ChevronDown, Code2, Copy, Download, ExternalLink, Github, Linkedin, Mail, Menu, Mountain, Pause, Play, Search, Sparkles, X } from 'lucide-react';
      ...
      <section id="ground" className="ground-section chapter">
        ...
        <div className="hero-layout">
          <div className="hero-copy">
            ...
            <div className="hero-actions"><a className="button primary" href="#mountain">ออกเดินทางด้วยกัน <ArrowDown size={16} /></a><a className="resume-link" href={resumeUrl} download="Suthep-Jantawee-Resume.txt">ดาวน์โหลดเรซูเม่ <Download size={15} /></a></div>
          </div>
        </div>
